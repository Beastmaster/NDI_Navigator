/*=========================================================================
  ...
  Module:    $RCSfile: igstkImageSliceRepresentation.txx,v $
  Language:  C++
  Date:      $Date: 2010-12-07 16:20:10 $
...
::RequestReslice( )
{
  ...
  if( m_SliceOrientation == OffAxial)
    ...
    {
    // Calculate the reslice axes
    // Assume tip direction is -Z
    igstk::Transform::VectorType   vTip;
    ...
    for (unsigned int i=0; i<3; i++)
      ...
      m_ProbeTransform.ExportTransform( * t );
  ...
  else if ( m_SliceOrientation == HybridPerpendicular)
    {
        // Calculate the reslice axes
    vx.Fill( 0.0 );
