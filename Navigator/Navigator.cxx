...
Navigator::Navigator() : m_StateMachine(this)
{
 ...
 /* --   qinshuo  add -----*/
  ...
  igstkAddStateMacro( LoadingOverlay );   //New adds 
  ...
  igstkAddTransitionMacro( Initial, LoadMesh, 
                           Initial, ReportInvalidRequest );
  igstkAddTransitionMacro( Initial, LoadOverlay, 
                           Initial, ReportInvalidRequest );   //New adds
 ...
 //complete table for state: LoadingImage State
  ...
  igstkAddTransitionMacro( LoadingOverlay, Success,
                           ImageReady, ReportSuccessOverlayLoaded );

  igstkAddTransitionMacro( LoadingOverlay, Failure,
                           ImageReady, ReportFailuredOverlayLoaded );
  ...
  igstkAddTransitionMacro( LoadingOverlay, LoadImage, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, ConfirmImagePatientName, 
                           LoadingOverlay, ReportInvalidRequest );
  ...
  igstkAddTransitionMacro( LoadingOverlay, LoadToolSpatialObject, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, StartSetImageFiducials, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, SetPickingPosition, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, EndSetImageFiducials, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, RegisterTracker, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, StartSetTrackerFiducials, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, AcceptTrackerFiducial, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, EndSetTrackerFiducials, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, ConfigureTracker, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, InitializeTracker, 
                           LoadingOverlay, ReportInvalidRequest );

  igstkAddTransitionMacro( LoadingOverlay, StartTracking, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, StopTracking, 
                           LoadingOverlay, ReportInvalidRequest );
  igstkAddTransitionMacro( LoadingOverlay, DisconnectTracker, 
                           LoadingOverlay, ReportInvalidRequest );
  ...
  igstkAddTransitionMacro( ConfiguringTracker, LoadMesh, 
                           ConfiguringTracker, ReportInvalidRequest );
  igstkAddTransitionMacro( ConfiguringTracker, LoadOverlay, 
                           ConfiguringTracker, ReportInvalidRequest );  //New adds
  ...
  igstkAddTransitionMacro( TrackerConfigurationReady, LoadMesh, 
                           TrackerConfigurationReady, ReportInvalidRequest );
  igstkAddTransitionMacro( TrackerConfigurationReady, LoadOverlay, 
                           TrackerConfigurationReady, ReportInvalidRequest );   //New adds
  ...
  igstkAddTransitionMacro( InitializingTracker, LoadMesh, 
                           InitializingTracker, ReportInvalidRequest );
  igstkAddTransitionMacro( InitializingTracker, LoadOverlay, 
                           InitializingTracker, ReportInvalidRequest ); //New adds
  ...
  igstkAddTransitionMacro( TrackerInitializationReady, LoadMesh, 
                           TrackerInitializationReady, ReportInvalidRequest );
  igstkAddTransitionMacro( TrackerInitializationReady, LoadOverlay, 
                           TrackerInitializationReady, ReportInvalidRequest );   //New adds
  ...
  igstkAddTransitionMacro( EndingSetTrackerFiducials, LoadMesh, 
                           EndingSetTrackerFiducials, ReportInvalidRequest );
  igstkAddTransitionMacro( EndingSetTrackerFiducials, LoadOverlay, 
                           EndingSetTrackerFiducials, ReportInvalidRequest );  //New adds
  ...
  igstkAddTransitionMacro( TrackerFiducialsReady, LoadMesh, 
                           TrackerFiducialsReady, ReportInvalidRequest );
  igstkAddTransitionMacro( TrackerFiducialsReady, LoadOverlay, 
                           TrackerFiducialsReady, ReportInvalidRequest );  //New adds
  ...
  igstkAddTransitionMacro( RegisteringTracker, LoadMesh, 
                           RegisteringTracker, ReportInvalidRequest );
  igstkAddTransitionMacro( RegisteringTracker, LoadOverlay, 
                           RegisteringTracker, ReportInvalidRequest );  //New adds
  ...
  igstkAddTransitionMacro( AcceptingRegistration, LoadMesh, 
                           AcceptingRegistration, ReportInvalidRequest );
  igstkAddTransitionMacro( AcceptingRegistration, LoadOverlay, 
                           AcceptingRegistration, ReportInvalidRequest );   //New adds
  ...
  igstkAddTransitionMacro( RegistrationReady, LoadMesh, 
                           RegistrationReady, ReportInvalidRequest );
  igstkAddTransitionMacro( RegistrationReady, LoadOverlay, 
                           RegistrationReady, ReportInvalidRequest );   //new adds
  ...
  igstkAddTransitionMacro( StartingTracker, LoadMesh, 
                           StartingTracker, ReportInvalidRequest );
  igstkAddTransitionMacro( StartingTracker, LoadOverlay, 
                           StartingTracker, ReportInvalidRequest );   //new adds
  ...
  igstkAddTransitionMacro( Tracking, LoadMesh, 
                           Tracking, ReportInvalidRequest );
  igstkAddTransitionMacro( Tracking, LoadOverlay, 
                           Tracking, ReportInvalidRequest );   //New adds
  ...
  igstkAddTransitionMacro( StoppingTracker, LoadMesh, 
                           StoppingTracker, ReportInvalidRequest );
  igstkAddTransitionMacro( StoppingTracker, LoadOverlay, 
                           StoppingTracker, ReportInvalidRequest );  //New adds
  ...
  igstkAddTransitionMacro( DisconnectingTracker, LoadMesh, 
                           DisconnectingTracker, ReportInvalidRequest );
  igstkAddTransitionMacro( DisconnectingTracker, LoadOverlay, 
                           DisconnectingTracker, ReportInvalidRequest ); //New adds
...
//New adds
void Navigator::RequestLoadOverlay()
{
  igstkLogMacro2( m_Logger, DEBUG, 
             "Navigator::RequestLoadOverlay called...\n" )
  m_StateMachine.PushInput( m_LoadOverlayInput );
  m_StateMachine.ProcessInputs();
}
...
//  m_ViewerGroup->m_CoronalViewAnnotation->RequestSetAnnotationText( 0, "" );
 ...
 // m_ViewerGroup->RequestUpdateOverlays();
  ...
  m_LoadOverlayButton->activate();           //New adds
...
/** Method to be invoked on successful target Overlay loading */ //New adds
void 
Navigator::ReportSuccessOverlayLoadedProcessing()
{
  
  igstkLogMacro2( m_Logger, DEBUG, "igstk::Navigator::"
                 "ReportSuccessOverlayLoadedProcessing called...\n");
}

/** Method to be invoked on failured target Overlay loading */  //New adds
void 
Navigator::ReportFailuredOverlayLoadedProcessing()
{
  igstkLogMacro2( m_Logger, DEBUG, "igstk::Navigator::"
                 "ReportFailuredOverlayLoadedProcessing called...\n");
}
...
//  m_ModifyFiducialsButton->color((Fl_Color)55);
    m_ModifyFiducialsButton->color((Fl_Color)77);
    m_ModifyImageFiducialsEnabled = false;
}
...
void Navigator::ConfirmPatientNameProcessing()
{
   ...
   //      m_PatientNameLabel->value( "CHAN TAI MAN" );
	   m_PatientNameLabel->value( m_ImageReader->GetPatientName().c_str() );
   }
   else
   {
...
void Navigator::RequestAcceptImageLoad()
{
  ...
  std::string Name = m_ImageReader->GetPatientName().c_str();
  m_ViewerGroup->m_AxialViewAnnotation->RequestSetAnnotationText( 0, Name );
  m_ViewerGroup->m_AxialViewAnnotation->RequestSetFontColor(0, 0.0, 0.0, 1.0);
  m_ViewerGroup->m_AxialViewAnnotation->RequestSetFontSize(0, 12);
 // m_ViewerGroup->m_AxialViewAnnotation->RequestSetAnnotationsViewPort(5,15);	

  m_ViewerGroup->m_SagittalViewAnnotation->RequestSetAnnotationText( 0, Name );
  m_ViewerGroup->m_SagittalViewAnnotation->RequestSetFontColor(0, 0.0, 0.0, 1.0);
  m_ViewerGroup->m_SagittalViewAnnotation->RequestSetFontSize(0, 12);

  m_ViewerGroup->m_CoronalViewAnnotation->RequestSetAnnotationText( 0, Name );
  m_ViewerGroup->m_CoronalViewAnnotation->RequestSetFontColor(0, 0.0, 0.0, 1.0);
  m_ViewerGroup->m_CoronalViewAnnotation->RequestSetFontSize(0, 12);

  m_ViewerGroup->m_AxialViewAnnotation->RequestSetAnnotationText(2, 
                                                                  "AXIAL");
  m_ViewerGroup->m_AxialViewAnnotation->RequestSetFontColor(2, 0.0, 0.0, 1.0);
  m_ViewerGroup->m_AxialViewAnnotation->RequestSetFontSize(2, 12);

  m_ViewerGroup->m_SagittalViewAnnotation->RequestSetAnnotationText(2, 
                                                               "SAGITTAL");
  m_ViewerGroup->m_SagittalViewAnnotation->RequestSetFontColor(2, 0.0, 0.0, 1.0);
  m_ViewerGroup->m_SagittalViewAnnotation->RequestSetFontSize(2, 12);
  ...
  if ( m_ImageObserver.IsNotNull() )
  {
	...
	//creating view
	m_WinProgress->show();
	m_WinProgress->label("Creating View");
	// Update the progress bar and value
	m_OutProgressMeter->value(50);
	m_OutProgressCounter->value(50);
	this->CenterChildWindowInParentWindow( m_WinProgress );
	m_WinProgress->make_current();
	Fl::check();
    this->ConnectImageRepresentation();    // this line is very import: connect connect image to view
    //create view done
	m_WinProgress->hide();
...
void Navigator::LoadToolSpatialObjectProcessing()
{
 ...
 //  const char*  fileName = 
   ...
   /* m_ToolSpatialObject = CylinderType::New();  
    m_ToolSpatialObject->SetRadius( 5.0 );
...
/** -----------------------------------------------------------------
* Load overlay. This method asks for a file with the image(dcm dir).
* -----------------------------------------------------------------
*/
void Navigator::LoadOverlayProcessing()
{
...
void Navigator::StartSetTrackerFiducialsProcessing()
{
 ...
 // m_FiducialsPointList->activate();  //Sun modify
...
void Navigator::EndSetTrackerFiducialsProcessing()
{
  ...
  if (numberOfAcceptedLandmarks >= 3)
  {
    ...
    m_RegisterButton->activate();
    m_RegisterButton->color((Fl_Color)77);
    m_StateMachine.PushInput( m_SuccessInput );
  }
  else
  {
...
void Navigator::TrackerRegistrationProcessing()
{
  ...
  RegistrationType::Pointer m_LandmarkRegistration  = RegistrationType::New();
  ...
  {
    m_ImageToTrackerTransform  = lrtcb->GetTransform();
    ...
    //m_RegistrationTransform = lrtcb->GetTransform();   //Sun ephasizes I 
    m_RegistrationTransform=igstk::Transform::TransformCompose(m_ImageToTrackerTransform,m_ICPTransform);
...
void Navigator::ConnectImageRepresentation()
{
  ...
  */
  ...
  m_ViewerGroup->m_CoronalView->AddObserver(
   ...
   /** Add observer for picking events in the 3DView view */  //Sun pick
  m_3DViewPickerObserver = LoadedObserverType::New();
  m_3DViewPickerObserver->SetCallbackFunction( this, 
                                       &Navigator::_3DViewPickingCallback );

  m_ViewerGroup->m_3DView->AddObserver(
      igstk::CoordinateSystemTransformToEvent(), m_3DViewPickerObserver );
...
/** -----------------------------------------------------------------
*  Read the file with atlas label
*---------------------------------------------------------------------
*/
void Navigator::ReadLabelMapping()
{
      std::string   MappingFileName;
      MappingFileName = m_ImageDir + "/label.txt";
      m_MappingFile.open( MappingFileName.c_str());
	 ...
	 int voxel;
	 std::string label;
	 while (m_MappingFile >> voxel >> label) LabelMap[voxel]=label;
...
//  m_ViewerGroup->m_AxialViewAnnotation->RequestSetAnnotationsViewPort(5,15);	
  ...
  m_SkullOpacitySlider->activate(); //Sun
...
//Sun pick
void Navigator::_3DViewPickingCallback( const itk::EventObject & event)
{
  if ( igstk::CoordinateSystemTransformToEvent().CheckEvent( &event ) )
  {
    typedef igstk::CoordinateSystemTransformToEvent TransformEventType;
    ...
    m_ImageSpatialObject->RequestComputeTransformTo( m_WorldReference );
    ...
    {
      igstkLogMacro2( m_Logger, DEBUG, "Navigator::_3DViewPickingCallback could not get coordinate system transform...\n" )
      return;
    }
...
/**	for( unsigned int i = 0; i<4; i++)
    ...
    m_MRIOverlayRepresentation[i]->SetBGWindowLevel(m_WindowWidth, m_WindowWidth);   //Sun adds
    m_MRIOverlayRepresentation[i]->SetFGWindowLevel(m_WindowWidth, m_WindowWidth);
...
{   
 ...
 /** for(unsigned int i=0; i<3; i++ )
    {
    m_MRIOverlayRepresentation[i]->SetResliceTransform( t );           //Sun adds
    m_MRIOverlayRepresentation[i]->RequestReslice( );
    }**/
...
{
  m_TrackingSemaphore->color((Fl_Color)77);
...
{
  m_ReferenceSemaphore->color((Fl_Color)77);
...
void
Navigator::RequestPrepareToQuit()
{
  this->RequestStopTracking();
  this->RequestDisconnectTracker();
}

void Navigator::SetOpacityOfImplant()
{
	meshRepresentation->SetOpacity(m_SegmentationOpacitySlider->value());
}

void Navigator::SetOpacityOfSkull()
{
   m_ImageRepresentation3D->updateOpacityTransferFunction(m_SkullOpacitySlider->value());
}

void Navigator::RequestScreenShot()
{
   m_ViewerGroup->SaveQuadrantViewsScreenShot();
}

void Navigator::Picking( const itk::EventObject & event)
{
  if ( igstk::CoordinateSystemTransformToEvent().CheckEvent( &event ) )
    {
    typedef igstk::CoordinateSystemTransformToEvent TransformEventType;
    ...
    MeshObjectType::PointType  point = TransformToPoint( transform );
    
	//int choice = TPointList->value();
...
void Navigator::RequestLoadTarget()
{
   ...
   for (int i = 0;i < numVerts;i++)
   {
    ...
    meshObject->RequestSetTransformAndParent( transform, m_View3D );

	m_View3D->SetRendererBackgroundColor(1,1,1);
	

	igstk::MeshObjectRepresentation::Pointer TargetMeshRepresentation = igstk::MeshObjectRepresentation::New();
	TargetMeshRepresentation->RequestSetMeshObject( meshObject );
    TargetMeshRepresentation->SetColor(1.000000, 0.937033, 0.954531);  // make it blue
    TargetMeshRepresentation->SetOpacity(1.0);

	m_View3D->RequestAddObject( TargetMeshRepresentation );

	m_View3D->SetCameraPosition( 0, 0, -1 );
    m_View3D->SetCameraViewUp( 0, -1, 0 );
    m_View3D->SetCameraFocalPoint( 0, 0, 0 );

	/** Add observer for picking events in the 3DView view */  //Sun pick
    m_View3DPickerObserver = LoadedObserverType::New();
    m_View3DPickerObserver->SetCallbackFunction( this, 
                                       &Navigator::Picking);

    m_View3D->AddObserver(
      igstk::CoordinateSystemTransformToEvent(), m_View3DPickerObserver );
...
void Navigator::RequestLoadMoving(){

    const char * Movingfile = 
    fl_file_chooser("Select the target point set file","*.stl", m_ImageDir.c_str());

	vtkSmartPointer<vtkSTLReader> movingreader = vtkSmartPointer<vtkSTLReader>::New();
    movingreader->SetFileName(Movingfile);
    movingreader->Update();
    vtkPolyData* polyData1 = movingreader->GetOutput();

	igstk::MeshObject::Pointer meshObject1 = igstk::MeshObject::New(); 

    int numPts1 = polyData1->GetNumberOfPoints();
	
    vtkCellArray * verts1 = polyData1->GetPolys();
	
    int numVerts1 = verts1->GetNumberOfCells();
		
    for (int i = 0;i < numPts1;i++)
   {
	double* pt = polyData1->GetPoint(i);
	meshObject1->AddPoint(i,pt[0],pt[1],pt[2]);
   }
		
    verts1->InitTraversal();
   ...
   for (int i = 0;i < numVerts1;i++)
   {
	...
	verts1->GetNextCell(count1,pts1);
		
	meshObject1->AddTriangleCell(i,pts1[0],pts1[1],pts1[2]);
   }
    ...
    meshObject1->RequestSetTransformAndParent( transform, m_View3D2 );

	m_View3D2->SetRendererBackgroundColor(1,1,1);
	

	igstk::MeshObjectRepresentation::Pointer MovingMeshRepresentation = igstk::MeshObjectRepresentation::New();
	MovingMeshRepresentation->RequestSetMeshObject( meshObject1 );
    MovingMeshRepresentation->SetColor(1.000000, 0.937033, 0.954531);  // make it blue
    MovingMeshRepresentation->SetOpacity(1.0);

	m_View3D2->RequestAddObject( MovingMeshRepresentation );

	m_View3D2->SetCameraPosition( 0, 0, -1 );
    m_View3D2->SetCameraViewUp( 0, -1, 0 );
    m_View3D2->SetCameraFocalPoint( 0, 0, 0 );


	m_View3D2->RequestResetCamera();
	m_View3D2->SetRefreshRate(VIEW_3D_REFRESH_RATE); 
	m_View3D2->RequestStart();

}
void Navigator::ChangeSelectedSurface(int sf)
{
  if(sf ==0)
    {
    
    this->ChangeSelectedTPoint();
    }
  else
    {
    this->ChangeSelectedTPoint();
...
void Navigator::ChangeSelectedTpoint(){
