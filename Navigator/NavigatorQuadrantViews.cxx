  ...
  : Fl_Group(X, Y, W, H, L)
{
  ...
  //--------add by qinshuo--------//
  //2. Create views
  new_SagittalView    = ViewType2D::New();
  new_SagittalView->RequestSetOrientation( ViewType2D::Sagittal );
  new_AxialView    = ViewType2D::New();
  ...
  //------slider useless---
    {
    Fl_Value_Slider* o = useless_slider = 
      new Fl_Value_Slider(X+m_WW+2*C, Y+m_HH*2+N, m_WW, N);
    o->type(5); 
    o->box(FL_DOWN_FRAME);
	o->textcolor( FL_WHITE );
    o->maximum(3);
  ...
  m_Sliders.push_back( useless_slider );

   {
    Fl_Value_Slider* o = new_Sagittal_Slider = 
      new Fl_Value_Slider(X+C, Y+m_HH*3+N*2, m_WW, N);
    o->type(5);
    o->box(FL_DOWN_FRAME);
	o->textcolor( FL_WHITE );
    o->maximum(3);
    o->step(1);
    o->callback((Fl_Callback*)cb_new_Saggital_Slider);
    o->deactivate();
    }
  m_Sliders.push_back( new_Sagittal_Slider );

   {
    Fl_Value_Slider* o = new_Axial_Slider = 
      new Fl_Value_Slider(X+m_WW+2*C, Y+m_HH*3+N*2, m_WW, N);
    o->type(5);
    o->box(FL_DOWN_FRAME);
	o->textcolor( FL_WHITE );
    o->maximum(3);
    o->step(1);
    o->callback((Fl_Callback*)cb_new_Axial_Slider);
    o->deactivate();
    }
  m_Sliders.push_back( new_Axial_Slider );
