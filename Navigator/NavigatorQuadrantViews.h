...
public:
  ...
  //--------add by qinshuo------//
  ViewType2D::Pointer          new_SagittalView;
  ViewType2D::Pointer          new_AxialView;
  igstk::Annotation2D::Pointer        new_SagittalViewAnnotation;
  igstk::Annotation2D::Pointer        new_AxialViewAnnotation;
  igstk::FLTKWidget * new_SagittalWidget;
  igstk::FLTKWidget * new_AxialWidget;
  Fl_Value_Slider* new_Sagittal_Slider;
  Fl_Value_Slider* new_Axial_Slider;
  Fl_Value_Slider * useless_slider;
  void cb_new_Saggital_Slider_i(Fl_Value_Slider*, void*){};
  static void cb_new_Saggital_Slider(Fl_Value_Slider*, void*){};
  void cb_new_Axial_Slider_i(Fl_Value_Slider*, void*){};
  static void cb_new_Axial_Slider(Fl_Value_Slider*, void*){};
   //--------add by qinshuo------//
