/*=========================================================================
  ...
  Module:    igstkImageSliceObjectRepresentation.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __igstkImageSliceObjectRepresentation_h
#define __igstkImageSliceObjectRepresentation_h
...
/** \class ImageSliceObjectRepresentation
 * 
...
class ImageSliceObjectRepresentation : public ObjectRepresentation
{
...
public:
  ...
  igstkStandardTemplatedClassTraitsMacro( 
                ImageSliceObjectRepresentation,ObjectRepresentation )
...
protected:
  ...
  /** Constructor */
  ImageSliceObjectRepresentation();
...
private:
  ...
  ImageSliceObjectRepresentation(const Self&);
...
#include "igstkImageSliceObjectRepresentation.txx"
#endif


#endif // __igstkImageSliceObjectRepresentation_h
